-- Remove duplicate function to fix the ambiguity error
DROP FUNCTION IF EXISTS public.create_city_viewer_user(_user_id uuid, _first_name text, _last_name text, _phone text, _city_ids uuid[]);
