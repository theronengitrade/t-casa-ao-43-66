...
CREATE OR REPLACE FUNCTION public.promote_resident_to_coordination(_resident_id uuid, _role public.coordination_member_role, _position text, _has_system_access boolean DEFAULT true)
RETURNS json
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = ''
